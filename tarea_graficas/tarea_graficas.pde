...
void setup() 
{
  ...
  table = loadTable("graficas.csv", "header");
...
void drawScatter()
{
  ...
  for (int i = 0; i < rowCount; i++) // desde la 0 hasta la 13
  {
      ...
      float x = map(i, 0, rowCount-1, 75, 475); //desde la 0 hasta la 13
      line(x, 80, x, 300);
